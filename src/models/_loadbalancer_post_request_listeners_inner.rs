...
pub struct LoadbalancerPostRequestListenersInner {
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(rename = "port", skip_serializing_if = "Option::is_none")]
    pub port: Option<i32>,
    #[serde(rename = "targets", skip_serializing_if = "Option::is_none")]
    pub targets: Option<Vec<crate::models::LoadbalancerPostRequestListenersInnerTargetsInner>>,
}

impl LoadbalancerPostRequestListenersInner {
    pub fn new() -> LoadbalancerPostRequestListenersInner {
