...
pub struct VpcIdPutRequest {
    /// Public IPv4 address of the member
    #[serde(rename = "ip4public")]
    pub ip4public: String,
    /// Private IPv4 address of the member
    #[serde(rename = "ip4private", skip_serializing_if = "Option::is_none")]
    pub ip4private: Option<String>,
}

impl VpcIdPutRequest {
    pub fn new(ip4public: String) -> VpcIdPutRequest {
        VpcIdPutRequest {
            ip4public,
            ip4private: None,
        }
