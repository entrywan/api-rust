...
pub struct Cluster {
    ...
    /// Number of worker nodes assigned to the cluster
...
pub enum State {
    ...
    Running,
    #[serde(rename = "creating control plane")]
    CreatingControlPlane,
    #[serde(rename = "spawning worker nodes")]
    SpawningWorkerNodes,
    #[serde(rename = "generating credentials")]
    GeneratingCredentials,
    #[serde(rename = "formatting credentials")]
